...
$payment_disallowed_array = array(
  ...
  'billsafe_2', // Fallback for shop version <= 2.0.4.2
  'payone_installment',
  'payone_otrans',
);
    ...
    <table class="tableBody">
      <tr>
        ...
        <td class="boxCenter">         
          ...
          <div class="pageHeadingImage"><?php echo xtc_image((is_file(DIR_FS_ADMIN.DIR_WS_ICONS.'heading/icon_configuration.png')) ? DIR_WS_ICONS.'heading/icon_configuration.png' : DIR_WS_ICONS.'heading_configuration.gif'); ?></div>
